...
// fix for index page's input Element
// $("body").on('focus', '#from_city', function(event) {

// 	/* Act on the event */
// 	$("#from_city").css('color', '#000');
// 	if($("#from_city").val()!=="请输入出发城市"){
// 		$("#from_city").css('color', '#000');
// 		// $("#from_city").addClass("warm");
// 		// return false;
// 	}
...
// });
// $("body").on('blur', '#from_city', function(event) {
...
// 	$("#to_city").css('color', '#000');
// 	if($("#to_city").val()!=="请输入到达城市"){
// 		$("#to_city").css('color', '#000');
// 		// $("#from_city").addClass("warm");
// 		// return false;
// 	}
// });
// $("body").on('blur', '#to_city', function(event) {
