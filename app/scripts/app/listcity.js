...
var train_list_id_ele = document.createElement('DIV');
    train_list_id_ele.setAttribute('id', 'cityList');
    train_list_id_ele.setAttribute('class', 'coach_city_list');
    train_list_id_ele.style.position = 'absolute';
    train_list_id_ele.style.display = 'none';
    train_list_id_ele.style.zIndex = '9999';
    train_list_id_ele.style.top = '-1px';
document.body.appendChild(train_list_id_ele);
